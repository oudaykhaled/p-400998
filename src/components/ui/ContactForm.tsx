...
const ContactForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white w-full">
      <div className="bg-white flex items-center gap-2.5 overflow-hidden text-2xl text-[rgba(70,64,64,1)] whitespace-nowrap flex-wrap mt-2.5 p-2.5 max-md:max-w-full">
        <input
          type="text"
          name="name"
          value={formData.name}
      ...
      <div className="bg-white flex w-[836px] max-w-full gap-2.5 overflow-hidden text-[25px] text-white font-normal mt-2.5 p-2.5">
        <button
          type="submit"
